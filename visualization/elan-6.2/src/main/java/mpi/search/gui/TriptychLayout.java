...
/**
 * This class manages a horizontal layout of three components. The central 
 * component will always be exactly in the center and will be set to its
 * preferred size. The remaining space is distributed equally to the
 * components on the left and on the right. The height is set equal to the 
 * maximum height of the three components.
 *
 * @author klasal
 */
public class TriptychLayout implements LayoutManager {
     ...
     *
     * @return the minimum dimension of the central component
     */
    @Override
