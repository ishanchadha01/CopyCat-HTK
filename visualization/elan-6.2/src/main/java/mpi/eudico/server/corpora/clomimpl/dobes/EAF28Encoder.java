...
//##### per element methods that can be overridden in future versions of the encoder #####//
     ...
     * @param eafFactory the EAF factory
     ...
     * @param annotDocument the document element
     * @param transcription the transcription
     */
...
//           }
     ...
     * @param annotDocument the document element
     * @param transcription the transcription
     * @param getExtRefIdParams external reference parameters
     ...
     * @param eafFactory the EAF factory
     * @param annotDocument the document element
     * @param usedLocales a list of locales
     */
    ...
    /**
     * Common code for the DOM and the TemplateDOM to add the list of {@code <LANGUAGE>}s
     ...
     * 
     * @param storeOrder the tier order
     * @param eafFactory EAF28 or higher
     * @param annotDocument the annotation document
     * @param conVocs the controlled vocabularies
     */
...
//    				}
     ...
     * 
     * @param eafFactory EAF28 or higher. {@code <REF_LINK_SET>} were actually introduced in EAF 3.0.
     * @param annotDocument the document element
     * @param transcription the transcription
  ...
  //##### end per element methods that can be overridden in future versions of the encoder #####//
	 ...
	 * @return an id string for the external reference
	 */
