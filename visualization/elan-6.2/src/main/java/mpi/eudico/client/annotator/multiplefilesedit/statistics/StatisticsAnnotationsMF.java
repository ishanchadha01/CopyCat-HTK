...
/**
 * Annotation statistics for multiple files.
 */
...
//            new DecimalFormatSymbols(Locale.US));
	 ...
	 * Constructor.
	 * 
	 * @param tier the tier to create annotation statistics for
	 */
	...
	/**
	 * Adds, actually sets, the tier to create statistics for.
	 * If a tier has already been set, this method silently returns.
	 * 
	 ...
	 * The columns are:<br>
	 * tier name ; annotation value ; number of occurrences ; minimal duration ;
	 *  maximum duration ; average duration ; median duration ; total duration ; latency
	 *  
	 * @return a list of string arrays, one array for each unique annotation value
	 */
	...
	/**
	 * A data structure for the calculation of statistics per annotation value.
	 */
	class AnStats {
