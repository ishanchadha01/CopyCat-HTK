...
public class NgramCollection {
	...
	/**
	 * Creates a NgramCollection instance.
	 * 
	 * @param size the n-gram size
	 */
	...
	/**
	 * @return the average time of the annotations in the n-gram
	 */
	...
	/**
	 * 
	 * @return the average interval time of the annotations in the collection
	 */
	 ...
	 * 
	 * @param result The NgramStatsResult object we use to calculate stats on 
	 * @throws Exception if the sanity check fails
	 */
	...
	/**
	 * Lists the columns that we will export, used in conjunction with {@link #toCSV(String)}
	...
	/**
	 * Composes a string suitable for writing into an exported file in "CSV" format.
