...
/**
 * A dialog to change the "play around selection" value.
 * This sets the amount of milliseconds to add to both sides of the selection 
 * in order to play a wider segment than the selection.
 * 
