 ...
 * another (dependent) subdivision tier.
 * Tokenization means that for  every single token (word) in one parent
 * annotation, a new annotation on a dependent tier is being created.
 * e.g.<br>
 * <pre>
 * |this is a test|<br>
 * |this|is|a|test|
 * </pre>
 * The default delimiters are space, tab, newline, (carriage return and
 * form-feed). The user can specify other delimiters.
 *
 * @author Han Sloetjes
 * @version jul 2004
...
public class TokenizeDialog extends AbstractTwoTierOpDialog
     ...
     * @return {@code true} if the first tier is the parent of the second
     */
     ...
     * @return {@code true} if the tier has one or more child tiers
     */
