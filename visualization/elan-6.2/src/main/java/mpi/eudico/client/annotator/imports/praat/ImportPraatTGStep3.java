...
/**
 * Final step of the import {@code Praat TextGrid} process. Parsing of the file and
...
public class ImportPraatTGStep3 extends StepPane implements ProgressListener {
     ...
     * @param multiPane the parent pane
     * @param curTranscription the transcription
     * @param inNewTranscription if {@code true} a new transcription will be
     * created for the imported tiers and annotations
     */
    public ImportPraatTGStep3(MultiStepPane multiPane,
