...
//    private boolean bRestored;
     ...
     *
     * @param layoutManager the layout manager of the main frame
...
*/
    /**
     * Sets the aspect ratio for the detached component.
     *
    ...
    /**
     * After a change in window size, the component is repositioned with respect
     * to its aspect ratio. The component will be scaled as large as possible.  
     */
    @Override
    ...
    /**
     * Translate an exit of the detached frame into re-attaching the component
     * to the main frame.
     */
