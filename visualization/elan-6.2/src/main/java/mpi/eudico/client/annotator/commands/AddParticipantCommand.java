...
/**
 * A command to add tiers for a new participant to the transcription. 
 * Either based on an existing tier structure (top level tier with dependent 
 * tiers) or on (the tiers for) an existing participant.
 */
