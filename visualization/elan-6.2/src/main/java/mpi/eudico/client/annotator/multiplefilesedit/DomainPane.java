...
/**
 * A panel with UI elements for selecting and loading a domain, a set of
 * EAF files and/or directories containing EAF files. 
 */
...
//    private boolean reloadTierList=false;
    ...
    /**
     * Constructor.
     * @param mfeParent the parent frame, the multiple file editor
     */
	...
	/**
	 * Applies localized texts to UI elements.
	 */
...
//            reloadTierList = true; // the domain changed
	 ...
	 * 
	 * @param b if {@code true} the elements will be enabled
	 */
