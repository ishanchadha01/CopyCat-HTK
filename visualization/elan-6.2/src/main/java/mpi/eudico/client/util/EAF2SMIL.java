...
public class EAF2SMIL {
    ...
    /**
     * Export without a reference to a media file.
     *
     * @param eafFile the input file
     * @param smilFile the output file
     * @param tierNames the tiers to include
     * @param offset the media offset
     * @param minimalDur the minimal duration to apply to each annotation, if possible
     * @param fontSettingHashMap a tier name to Font mapping
     *
     * @throws IOException any IO exception
     * @throws TransformerException any transformation exception
     */
    ...
    /**
     * Export with a reference to a media file.
     *
     * @param eafFile the input file
     * @param smilFile the output file
     * @param tierNames the selected tiers
    ...
    /**
     * Export with a reference to a media file, providing an input URL.
     *
     * @param eafURL the input URL
     * @param smilFile the output file
     * @param tierNames the selected tier names
     * @param mediaURL reference to a media file
     * @param offset the media offset
     * @param minimalDur the minimal duration to apply to each annotation, if possible
     * @param fontSettingMap a tier name to Font mapping
     * 
     * @throws IOException any IO exception
     * @throws TransformerException any transformation exception
     */
    ...
    /**
     * Export without a reference to a media file but restricting the output
     * to a selected time interval.
     *
     * @param eafFile the input file
     * @param smilFile the output file
     * @param tierNames the selected tier names
     * @param beginTime the begin time of the interval
     * @param endTime the end time of the interval
     * @param offset the media offset
     * @param minimalDur the minimal duration to apply to each annotation, if possible
     * @param recalculateTime if {@code true} the annotation times are corrected
     * based on the offset
     * @param fontSettingHashMap a tier name to Font mapping
     * 
     * 
    ...
    public void export2SMIL(File eafFile, File smilFile, String[] tierNames,
        long beginTime, long endTime,long offset, int  minimalDur, boolean recalculateTime, 
        	Map<String, Object> fontSettingHashMap) throws IOException, TransformerException {
        export2SMIL(eafFile, smilFile, tierNames, null, beginTime, endTime, offset, minimalDur, recalculateTime, fontSettingHashMap);
    }

    /**
     * Export with a reference to a media file but restricting the output
     * to a selected time interval.
     *
     * @param eafFile the input file
     * @param smilFile the output file
     ...
     */
    public static void export2SMIL(File eafFile, File smilFile,
        String[] tierNames, String mediaURL, long beginTime, long endTime, long offset, int  minimalDur, 
        boolean recalculateTime, Map<String, Object> fontSettingHashMap)
        throws IOException, TransformerException {
        try {
            URL eafURL = new URL("file:///" + eafFile.getAbsolutePath());
    ...
    /**
     * Export of a transcription, with a reference to a media file and 
     * restricting the output to a selected time interval.
     *
    ...
    /**
     * Export based on an input URL, with a reference to a media file and 
     * restricting the output to a selected time interval. 
     *
     * @param eafURL the input URL
     * @param smilFile the output file
    ...
    /**
     * Sets the xsl-scripts and creates Transformers.
     *
     * @throws TransformerException if creation of transformers fails
     * @throws IOException any IO exception
     */
