...
/**
 * Viewer for a subtitle style visualization of the annotations of a tier.
 * 
...
public class SubtitleViewer extends AbstractViewer implements SingleTierViewer,
    ...
    /**
     * Creates a new SubtitleViewer instance.
     *
     */
    ...
    /**
     * Sets the minimum size for the subtitle viewer. See also getPreferredSize
     *
    ...
    /**
     * Returns the preferred size for the subtitle viewer.
     *
    ...
    /**
     * Repaints, the selection is checked in the painting operation.
     */
    @Override
    ...
    /**
     * Updates the view, this checks which annotation should be visible,
     * if any.
     *
     */
    @Override
     ...
     * in a selection. 
     * Sets the correct value in the subtitle viewer.
     */
    public void doUpdate() {
        ...
        if ((tier != null) && (selectionBeginTime != selectionEndTime) &&
            ...
            try {
                ...
                //ex.printStackTrace();
                LOG.warning("Cannot add a highlight: " + ex.getMessage());
            }
        } else {
...
//    			}
    ...
    /**
     * Handles mouse actions on the subtitle viewer.
     */
