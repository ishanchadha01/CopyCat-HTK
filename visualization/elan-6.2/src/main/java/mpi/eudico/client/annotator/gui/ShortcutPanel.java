...
/**
 * A panel showing all actions that can have a shortcut in a table and 
 * that allows to select one and change the shortcut.
 * The action are presented in tabs corresponding to the modes in ELAN, 
 * with one tab for common, mode independent actions.
 * 
 * @author alekoe
 *
 */
...
public class ShortcutPanel extends JPanel implements ActionListener {
     ...
     * @param modeName the name of the mode for which the shortcuts are to be 
     * loaded in the above given model
     */
    ...
    /**
     * Method to ensure that the shortcuts stored in the member variable and 
     ...
     *  
     * @param selectedAction the action selected in the table for which the 
     * shortcut should be edited
     * @param codes a list of size 2, for the key code and the modifiers
     */
    ...
    /**
     * Changes the shortcut for the currently selected action to the specified
     * keyStroke.
     * 
     * @param ks the new shortcut keyStroke
     * @param applyInAllModes if {@code true} the shortcut applies to all 
     * working modes
     */
