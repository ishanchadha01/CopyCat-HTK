...
public class AnnotationStatisticsPanel extends AbstractStatisticsPanel
     ...
     * Note: any changes in the number or order of columns have to be taken into account
     ...
     * <p>
     * Mar 2009: a flag is introduced to change the counting behavior
     *
     * @param tier the tier
    ...
    /**
     * Sets the observation time boundary: - the beginning boundary equals the
     ...
     * <p>
     * Mar 09: added the option to use the media duration as the observation period
     */
     ...
     * time between the beginning of the observation period and the first
