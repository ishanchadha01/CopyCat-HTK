...
/**
 * A two dimensional table of integer values with one set of labels for both
 * the column and the row headers. 
 * This class provides methods for incrementing cell values and for adding 
 * a specific number to the value of a cell.   
 */
public class AgreementTable {
	 ...
	 * @param rowLabel the row label identifying a row
	 * @param colLabel the column label
	 * @param count the number to add to the current value in that cell
	 * 
