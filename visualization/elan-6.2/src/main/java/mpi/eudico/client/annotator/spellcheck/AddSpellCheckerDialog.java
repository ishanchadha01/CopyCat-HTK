...
public class AddSpellCheckerDialog extends ClosableDialog implements ActionListener, ItemListener {
	 ...
	 * @param modal the modality flag
	 * @param transcription a transcription for the languages list, can be {@code null}
	 */
	...
	private void createSpellChecker() {
		...
		try {
			...
			if(LOG.isLoggable(Level.WARNING)) {
            	LOG.warning("Could not create a spell checker (" + e.getMessage() + ")");
            }
		}
	}
	...
	/**
	 * Returns the created spell checker.
	 * @return the created spell checker or {@code null}
	 */
...
//	    setSize(700,260);
	 ...
	 * @return a combobox for languages, possibly empty
	 */
