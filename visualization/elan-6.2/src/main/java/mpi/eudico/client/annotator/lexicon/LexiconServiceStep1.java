 ...
 * It lets the user fill in the name of the Lexicon Link, the Lexicon Service Type, the URL and the user name 
 * and password .
 * 
...
public class LexiconServiceStep1 extends StepPane implements ActionListener, ItemListener, KeyListener {
    ...
    /**
     * @see mpi.eudico.client.annotator.gui.multistep.Step#leaveStepBackward()
     */
    @Override
