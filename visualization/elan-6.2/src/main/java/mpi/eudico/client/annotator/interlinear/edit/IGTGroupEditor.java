...
public class IGTGroupEditor extends JComponent
	implements MouseListener, KeyListener, IGTDataModelListener {
	 ...
	 * Constructor.
	 * 
	 * @param editProvider the edit provider
	 * @param viewer the IGT viewer 
	 */
	 ...
	 * 
	 * @return the selected, active annotation
	 */
	 ...
	 * 
	 * @param newSelectedAnn the new selected annotation
	 */
	 ...
	 * 
	 * @param ann the annotation to repaint
	 */
