...
public abstract class AbstractEditCVDialog extends JDialog
    ...
    /**
     * Test main method with an cv list of size 1
    ...
    /**
     * Changes the properties of a CV.
     * Checks whether the name is valid and unique.
     */
    ...
    */
    ...
    /**
     * Deletes the selected CV.
     * If the CV is not empty, ask the user for confirmation.
     */
