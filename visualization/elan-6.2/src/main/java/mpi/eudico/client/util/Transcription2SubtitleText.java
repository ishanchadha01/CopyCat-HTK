...
/**
 * Exports annotations of a selection of tiers to a DVD subtitle text format.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class Transcription2SubtitleText {
     ...
     * @param reCalculateTime if {@code true} make Selection begin time to start from zero 
     *        and not the actual begin time
     *
     ...
     * @param exportFile the file to export to
     * @param encoding the file encoding, defaults to UTF-8
     * @param beginTime the (selection) begint ime
     * @param endTime the (selection) end time
     * @param minimalDuration the minimal duration per subtitle
     * @param offset the media offset
     *
