...
public abstract class AbstractMultiFileExportProgessStepPane extends ProgressStepPane {
    ...
    /**
     * Disables all buttons, starts the export in a separate thread and returns
     * {@code false}
     * 
     * @return {@code false}
     */
	...
	private class ExportThread extends Thread{		
		...
		/**
		 * Gets the file name of the specified transcription and edits it to 
		 * the format specified for the export
		 * 
