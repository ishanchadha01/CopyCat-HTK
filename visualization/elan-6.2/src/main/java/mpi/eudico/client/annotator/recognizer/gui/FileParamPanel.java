...
public class FileParamPanel extends AbstractParamPanel implements ActionListener {
	 ...
	 */
	public FileParamPanel(String paramName, String description, boolean inputType, int contentType, 
			boolean optional) {
	 ...
	 */
	public FileParamPanel(String paramName, String description, boolean inputType, 
			int contentType, boolean optional, List<String> mediaFiles) {
	...
	/**
	 * Constructor accepting a {@code FileParam} as an argument.
	 * 
	 * @param param the file parameter object
	 */
	...
	/**
	 * Adds a textfield and a browse button or a combobox to the panel.
	 */
	@Override
	...
	/**
	 * Check whether the given media file is supported for this parameter.
	 * 
	 * @param mediaFilePath media file to be checked
	 * 
	 * @return {@code true} if this parameter supports the
	 *                       given media file
	 * 
	 */
	public boolean isMediaSupported(String mediaFilePath) {
		...
		String mime = MediaDescriptorUtility.mimeTypeForExtension(ext);
	...
	/**
	 * Returns the content type of this file parameter.
	 * One of the {@code FileParam} constants e.g. {@code FileParam#AUDIO}, 
	 * {@code FileParam#VIDEO} etc.
	 * 
	...
	/**
	 * Returns whether there is file text field.
	 * 
	 * @return {@code true} if there is a file input field 
	 */
	...
	/**
	 * Returns whether there is a parameter value.
	 * 
	 * @return {@code true} if there is non-empty string value
	 */
	...
	/**
	 * Returns whether this is an input or output file panel.
	 * 
	 * @return {@code true} if this is an input file panel, {@code false} if 
	 * this is an output file panel
	 */
	 ...
	 * 
	 * @return a list of extension string arrays
	 */
		...
		if (contentType == FileParam.CSV_TS || contentType == FileParam.CSV_TIER) {
			...
			if(mimeTypes != null){
				...
				for(int i=0; i < mimeTypes.size(); i++){	
					...
					extArray = MediaDescriptorUtility.extensionForMimeType(mimeType);
