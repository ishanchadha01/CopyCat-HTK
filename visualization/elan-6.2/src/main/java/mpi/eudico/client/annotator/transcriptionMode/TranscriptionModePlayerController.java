...
public class TranscriptionModePlayerController implements ChangeListener, ActionListener {
     ...
     * @param viewer the transcription viewer
     */
    ...
    /**
     * Returns the time to wait or pause between loops.
     *
     * @return the wait time between loops
     */
    ...
    /**
     * Sets the time between two loops.
     *
     * @param loopTime the time to wait between loops in loop mode
     */
	 ...
	 * 
	 * @return a customized volume and rate panel
	 */
    ...
    /**
     * Returns the play/pause button etc. panel.
     *
     * @return a customized panel with play/pause buttons
     */
    ...
    /**
     * Returns the customized selection button panel.
     *
     ...
     *
     * @return {@code true} if loop mode is enabled, {@code false} otherwise
     */
     ...
     *  
     * @return a customized selection panel
     */
    ...
    /**
     * Starts a new playing thread when loop mode is true.
     */
