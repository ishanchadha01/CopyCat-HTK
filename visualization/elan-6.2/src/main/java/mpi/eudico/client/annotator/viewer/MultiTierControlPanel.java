...
public class MultiTierControlPanel extends JPanel implements MouseListener,
    ...
    /** Holds pair of {@code <tierName, its tierTreeNode>}*/
    private Map<String, TierTreeNode> tierTreeNodeMap;
    
    /** Holds a pair of {@code <tier, tierNames>} */
    ...
    /**
     * Creates a control panel for one or more multiple tier viewers.
     *
     * @param transcription the loaded transcription containing the tiers etc.
...
//        }
    ...
    /**
     * Sets the UI component that is used for changing the width of the panel.
     *  
     * @param comp the resize component
     */
     ...
     * 
     * @param val if {@code true} the Interlinear viewer menu item is disabled
     */
    ...
    /**
     * Sets the (main) viewer that must be controlled.
     * Two types of viewers are recognized, the {@link TimeLineViewer} and the
     * {@code InterlinearViewer}.
     *
     * @param viewer the viewer to connect
     */
    ...
    /**
     * Removes a viewer as a listener.
     *
    ...
    private void updateTierSetMenu(){    
        ...
        if (LOG.isLoggable(Level.FINE)) {
        	LOG.fine("updateTierSetMenu " + tierSetList.size());
        }
     ...
     * 
     * @param sortmode a sorting constant, one of the {@code SORT_BY_} constants
...
//        }
    ...
    /**
     * Adds the MultiTier Viewer items to the popup (when necessary) and
    ...
    /**
     * A double click activates a tier.
     */
    @Override
...
//                        "MultiTierControlPanel.Menu.Unsorted");
     ...
     * relevant changes by the connected viewer.
...
//            }
    ...
    /**
     * Tells the ControlPanel which is the new active tier.
     ...
     * @param active if {@code true} the tier becomes active
     */
	...
	/**
     * Adds a tier - color pair to the table of root tier colors.
...
//    }
    ...
    /**
	 * Create a semi-random color based on three predefined color values.
	...
	/**
     * Creates a BufferedImage when necessary and paints the tier labels in this
     * buffer.
     */
     ...
     * @param node the tier's node to paint
     * @param positionIndex the index in the array of displayable tiers
     * @param availableLabelWidth the available width for the tier label
...
//    		}
    ...
    //**********************************************************************
    /**
     * A class to paint the name of a tier in the <code>MultiTierControlPanel </code>.
    ...
    public class TierTreeNode extends DefaultMutableTreeNode {
         ...
         *
         * @param tier the tier, the user object of the node
         */
        ...
        /**
         * Returns the tier that is the user object of this node.
         *
         * @return the tier
         */
         ...
         *
         * @param tier the user object of this node
         */
