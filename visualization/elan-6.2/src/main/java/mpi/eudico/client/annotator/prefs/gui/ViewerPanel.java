...
public class ViewerPanel extends AbstractEditPrefsPanel implements PreferenceEditor, MouseListener, ActionListener {
    ...
    * @return if {@code true}, the given viewer is in the right pane of the video
    * 				if {@code false}, it is on the left pane of the video
    */
    ...
    /**
	 * Updates the {@code videoInCentre} value.
	 * 
	...
	/**
	 * Updates the viewer selection panel. 	  
	 */
