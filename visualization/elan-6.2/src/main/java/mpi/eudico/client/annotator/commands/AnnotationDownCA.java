...
public class AnnotationDownCA extends CommandAction {
    ...
    /**
     * Creates a new ActiveAnnotationCommand.
     */
    @Override
    ...
    /**
     * Tries to find the annotations "below" the current active annotation. 
     * If possible this is an overlapping annotation on a tier which is 
     * visually below, in the user interface, the current active annotation.
     * 
     * @return an array containing the new active annotation
     */
    @Override
