...
/**
 * A search panel for configuring a query in multiple files.
 *
...
public class EAFMultipleFileSearchPanel extends AbstractSimpleSearchPanel {
    ...
    /**
     * Returns a predefined preferred size.
     *
     * @return the initial preferred size
     */
    @Override
    ...
    /**
     * Returns the files in the {@code domain}.
     *
     * @return an array of files to search
     */
    ...
    /**
     * Notification that the search engine started.
     */
    @Override
    ...
    /**
     * Notification that query execution stopped.
     */
    @Override
    ...
    /**
     * Show a message when receiving an error.
     *
     * @param e the exception, the cause
     */
    @Override
    ...
    /**
     * Returns a new content query instance. 
     *
    ...
    /**
     * Shows a save as dialog an exports the results.
     */
    @Override
