...
public class ExportTiersDialog extends AbstractExtTierExportDialog{	
	 ...
	 * @return {@code true} if it is in the list ({@code index >= 0})
	 */
	...
	private class SaveFileThread extends Thread{
		...
		/**
		 * Gets the file name of the specified transcription and edits it to the
		 * format specified for the export.
		 * 
