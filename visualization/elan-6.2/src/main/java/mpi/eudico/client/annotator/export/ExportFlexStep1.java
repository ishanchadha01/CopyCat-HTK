...
public class ExportFlexStep1 extends StepPane{	
	...
	/** a hash map of {@code flexType - list<linguistic types>} */
    ...
    public static final String INTERLINEAR_TEXT_TIER = "ExportFLExDialog.InterlinearTextTier";
	 ...
	 * @return boolean {@code true} if it might be a phrase tier
	 */
	...
	private void loadPreferences(){
		...
		String tierName = Preferences.getString(INTERLINEAR_TEXT_TIER, null);
		if (tierName != null) {
			textCombo.setSelectedItem(tierName);
		}
	...
	private void storePreferences(){
		...
		if (textCB.isSelected() && textCombo.getSelectedItem() != SELECT_TIER) {
			Preferences.set(INTERLINEAR_TEXT_TIER, textCombo.getSelectedItem(), null);
		}
