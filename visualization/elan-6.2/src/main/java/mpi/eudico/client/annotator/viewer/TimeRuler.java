 ...
 * In version 0.2 the paint method has been changed such that rounded values 
 ...
 * @version 0.2 and 0.3 oct-nov 2005 
 */
public class TimeRuler {
    ...
    /** base values for round label values */
    ...
    /**
     * Constructs a TimeRuler using the specified Font and a default label.
     ...
     * @param font the font to use for the labels
     * @param defLabel the default time label, e.g. 00:00:000
     * @param extraHeight additional height for the ruler
     */
    ...
    /**
     * Paints a time ruler to the specified Graphics2D object.
     * A begin time (for an interval) and a width in pixels should be provided,
    ...
    public void paint(Graphics2D g2d, long beginTime, int width,
        ...
        // begin with a marker that is smaller than the begintime8\88888888\8888888888888888888888888
        long firstMarker = step * (beginTime / step);
        int firstLine = (int) (firstMarker / msPerPixel);
