...
/**
 * A pseudo-client that is mainly used for configuration purposes, for linking a tier
 * to a field in a lexical entry of a {@code LexiconComponent} lexicon.
 * 
 * @author Han Sloetjes
 */
public class LexiconComponentClient implements LexiconServiceClient {
	 ...
	 * @return null
	 * @throws LexiconServiceClientException if anything goes wrong while getting the lexicon
	 */
	@Override
	 ...
	 * to be used only for visualization (of search results).
	 * 
	 * @param lexId the id of the lexicon to get the entry structure from
	 * @return null 
	 * @throws LexiconServiceClientException if anything goes wrong while
	 * retrieving the entry structure
	 */
	@Override
