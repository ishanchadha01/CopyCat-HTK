...
/**
 * This class makes the GridViewer editable and lets it responds to changes in
 * ACM made elsewhere.
 * 
...
abstract public class AbstractEditableGridViewer extends AbstractGridViewer implements
     ...
     * used in the cells of the grid viewer. With that it creates a {@code Tier Name -> CveId -> Color} mapping.
     * <p>
     * Since the preferences contain a {@code CV name -> CveId -> Color} mapping, it could potentially
