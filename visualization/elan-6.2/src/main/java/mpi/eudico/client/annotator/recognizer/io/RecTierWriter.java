...
public class RecTierWriter {
	...
	/**
	 * Writes selections in the new XML format.
	 * 
	 * @param outputFile the file to write to
	 * @param tiers the list of segmentations (i.e. tiers) to write
	 * @param trans the transcription containing the data
	 *  
	 * @throws IOException if any IO related error occurs
	 */
	 ...
	 * 
	 * @param outputFile the destination file
	 * @param tiers the segments/selections, in ascending time order
	 * @param includeSelections if {@code false} only write the tiers/segmentations,
	 *  otherwise add individual selections
	 * @param xmlOut if {@code true} write XML format, otherwise write CSV format
	 * @throws IOException if any IO related error occurs
	 */
