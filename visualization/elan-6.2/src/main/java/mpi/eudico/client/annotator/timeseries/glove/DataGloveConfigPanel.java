...
public class DataGloveConfigPanel extends TSConfigPanel
    ...
    private void updateForTrack(String trackName) {
        if (trackName == null) {
            ...
            minTF.setValue(Float.valueOf(0));
            maxTF.setValue(Float.valueOf(100));
            deriv0RB.setSelected(true);
            colorButton.setBackground(Color.GREEN);
        ...
        if (currentTrack != null) {
            ...
            if (track != null) {
                ...
                if (range != null) {
                    minTF.setValue(Float.valueOf(range[0]));
                    maxTF.setValue(Float.valueOf(range[1]));
                } else {
                    minTF.setValue(Float.valueOf(0));
                    maxTF.setValue(Float.valueOf(100));
                }
    ...
    /**
     * Performs checks, creates a track(configuration) and adds it to the 
