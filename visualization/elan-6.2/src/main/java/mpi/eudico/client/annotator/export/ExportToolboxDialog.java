 ...
 * in the tier column, which normally contains Strings, it puts {@code SelectableObject<String>}s.
...
public class ExportToolboxDialog extends AbstractTierExportDialog
    ...
    /**
     * @param tier the root of the tree
     *
     * @return a list of tiers that are part of the tree
     */
...
*/
     ...
     *
     * @return {@code true} if all went well, {@code false} otherwise
     */
     ...
     * 
     * @return  tierOrder, {@code List<string>} 
     */
