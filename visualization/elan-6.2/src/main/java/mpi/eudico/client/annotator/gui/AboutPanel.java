...
public class AboutPanel extends JPanel {
    ...
    public AboutPanel() {
        super();
        citeELAN = String.format("ELAN (Version %d.%d) [Computer software]. (2021). Nijmegen: Max Planck Institute for Psycholinguistics, The Language Archive. Retrieved from %s", 
        		ELAN.major, ELAN.minor, Constants.ELAN_INFO_URL);
        initPanel();
    }
    ...
    private void initPanel() {
        ...
        textBuf.append("Copyright \u00A9 2001 - 2021");
        textBuf.append("<br>");
    ...
    private JPanel getCiteElanPanel(){    	
    	...
    	textBuf.append(String.format("<ul><li>the URL: <b>%s</b></li><br>", Constants.ELAN_INFO_URL));
    ...
    private JPanel getSoftwarePanel(){
    	...
    	textBuf.append("<ul><li><b>OpenJDK, Oracle</b> http://hg.openjdk.java.net/jdk</li><br>");
    	textBuf.append("<li><b>OpenJFX Platform</b> https://openjfx.io/</li><br>");
    	textBuf.append("<li><b>Apache Software Foundation</b> http://apache.org/</li><br>");    	
    	...
    	textBuf.append("<li><b>Staccato</b> SaGA (speech and gesture alignment) project</li>");
    	textBuf.append("</ul></html>");
