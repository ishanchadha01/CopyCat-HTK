...
public class ShoeboxMarkerDialog extends ClosableDialog implements ActionListener,
	...
	private JComboBox<String> currentMarkers = new JComboBox<String>();
    private JTextField markerTextField = new JTextField(30);
	private JComboBox<String> parents = new JComboBox<String>();
	private JComboBox<String> constraints = new JComboBox<String>();
    ...
    /**
     * Constructor. 
     * In Toolbox mode the marker encoding combo box is disabled (Unicode is assumed).
     *
     * @param theFrame the parent frame
     * @param modal whether the dialog should be modal or not
