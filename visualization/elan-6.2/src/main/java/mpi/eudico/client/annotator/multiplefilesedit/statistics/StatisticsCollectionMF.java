...
/**
 * A class in which statistics for annotations, tiers, types, participants and
 * annotators for multiple files are collected.
 * 
 * @author Han Sloetjes
 */
...
//            new DecimalFormatSymbols(Locale.US));
	...
	/**
	 * Constructor, initializes lists and maps.
	 */
	 ...
	 * The current overall statistics are updated with the new information.
	 * 
	 * @param file the name or path of the file containing the tier
	 * @param tier the tier to add
	 * @param numAnnotations the number of annotations of the tier
	 * @param minDur the minimal annotation duration
	 * @param maxDur the maximal annotation duration
	 * @param totalDur the total annotation duration
	 * @param latency the onset or first occurrence of an annotation
	 * @param curDurations a list of all annotation durations 
	 */
	...
	/**
	 * Adds annotation statistics of the tier to the map if the map doesn't already
	 * has a mapping with the tier name as key.
	 * 
	...
	/**
	 * Returns all annotation statistics.
	 * 
	 * @return all annotation statistics as a list of string arrays
	 */
	 ...
	 * tier name ; number of files the tier is in ; number of annotations ; 
	 * min duration ; max duration ; average duration ; median duration ; total duration ; latency 
	 ...
	 * (Sorting could be added). <br>
	 * The columns contain the following:<br>
	 * type name ; number of files ; number of tiers using the type ; number of annotations ; 
	 * min duration ; max duration ; average duration ; median duration ; total duration ; latency 
	 ...
	 * (Sorting could be added). <br>
	 * The columns contain the following:<br>
	 * participant name ; number of files ; number of tiers for participant ; number of annotations ; 
	 * min duration ; max duration ; average duration ; median duration ; total duration ; latency 
	 ...
	 * (Sorting could be added). <br>
	 * The columns contain the following:<br>
	 * annotator name ; number of files ; number of tiers for annotator ; number of annotations ; 
	 * min duration ; max duration ; average duration ; median duration ; total duration ; latency 
	 * 
	 ...
	 * The columns contain the following:<br>
	 * attribute name (or value actually) ; number of files ; number of tiers for 
	 * the attribute; number of annotations ; min duration ; max duration ; 
	 * average duration ; median duration ; total duration ; latency 
	 * 
