...
public class AnnotationSlicer {
	 ...
	 * 					to be extracted
	 * @return {@code ArrayList<Long>} or {@code null} if the tier list is {@code null}
	 */
    ...
    /**
     * Returns a map {@code <timeValue, List<annotations at this time value>>}.
     * 
     ...
     * 					have to be extracted
     * 
     * @return {@code HashMap<Long, ArrayList<Annotation>>}
     */
	 ...
	 * Returns {@code null} if any of the parameters is {@code null}.
	 * 
