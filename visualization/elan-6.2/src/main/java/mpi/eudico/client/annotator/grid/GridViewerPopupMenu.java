...
/**
 * Popupmenu for the AnnotationTable, for changing font size and layout of the table.
...
public class GridViewerPopupMenu extends JPopupMenu implements ActionListener {
	...
	/**
	 * Sets the time format, updates the popup menu items. Assumes that the 
	 * table is notified otherwise.
	 * 
