...
/**
 * The third step in the re-parent process:  allow or, in some cases, force to
...
public class CopyTierStep3 extends ProgressStepPane implements ListSelectionListener,
    ...
    /**
     * Remove the table and linguistic (tier) type button and add a progress
     * bar and a message label.
     */
