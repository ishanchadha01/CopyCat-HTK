...
public abstract class AbstractDestTierAndTypeSpecStepPane extends StepPane implements ListSelectionListener, ActionListener, KeyListener {
	 ...
	 * Constructor.
	 * 
	 * @param mp the parent step pane
	 * @param trans the transcription containing tiers and types
	 */
...
//		destinationTierConfigurationPanel.add(parentTierCB, gbc);
	...
	/**
	 * Updates the button states according to some constraints (like everything 
	 * has to be filled in, consistently).
	 */
	...
	/**
	 * Simple dialog which allows to specify the new linguistic or tier type
	 * name.
	 * 
	 * @author aarsom
	 */
