...
public class MergeUtil {
     ...
     * 
     * @param srcTrans the first transcription
     * @param destTrans the second transcription
     * @param selTiers the selected tiers
     * 
     ...
     * 
     *  @param t the first tier
     *  @param t2 the second tier
     *  
     *  @return {@code true} if the types of the two tiers have the same stereotype
     */       
     ...
     * @return true if the types have the same stereotype
     */
     ...
     * 
     * @return {@code true} if both constraints are {@code null} or if both 
     ...
     * 
     * @param <T> the type of Tier to sort
     * @param tiersToSort the tiers to sort
     * 
     * @return a new list with sorted tiers
     */
