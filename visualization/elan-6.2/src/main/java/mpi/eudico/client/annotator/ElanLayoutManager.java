...
public class ElanLayoutManager implements ElanLocaleListener, 
    ...
    /**
     * Creates a new ElanLayoutManager instance.
     *
     * @param elanFrame the content pane of the ElanFrameis the target of the layout
     * @param viewerManager the manager connecting viewers and players
     */
...
//		activeManager.initComponents();
    ...
    /**
     * Called after initialization and after a change in the UI language.
     * Forwards the call to the layout manager of the active mode.
     */
    @Override
     ...
     *
     * @param object the viewer, player or other component to add to the layout
     */
	 ...
	 *
	 * @param object the viewer, player or other component to remove
	 */
	...
	/**
	 * Update or create a viewer for the specified name.
	 * 
	 * @param viewerName the name or id of the viewer
	 * @param createViewer if {@code true} the viewer should be (re-)created, 
	 * if {@code false} the viewer is removed and destroyed
	 */
	 ...
	 *
	 * @param object the component to hide
	 */
	public void hide(Object object) {
	}
    
    /**
     * Add a media player to the layout manager.
...
//    	}         	
    ...
    /**
     * Removes a player from the layout manager.
     * Before adding/removing a player while in sync mode be sure that all players 
     * are connected by calling connectAllPlayers. 
     * 
...
//		}
	 ...
	 * 
	 * @return the TimeLineViewer, can be {@code null}
	 */
	 ...
	 * 
	 * @return the InterlinearViewer, can be {@code null}
	 */
	...
	/**
	 * Returns the TimeSeriesViewer or null.
	 * 
	 * @return the TimeSeriesViewer, can be {@code null}
	 */
    ...
    /**
     * Returns the multiple tier control panel, the panel showing the tier names
     * usually left of the connected viewer, like row headers.
     *
     * @return the multiple tier control panel, can be {@code null} 
     */
     ...
     * 
     * @return the {@code TimeLineViewer} or {@code InterlinearViewer} or {@code null}
     */
    ...
    /**
     * A request to show the {@code TimeLineViewer} and connect it to the 
     * multiple tier control panel. Will only have an effect in 
     * {@code #NORMAL_MODE} (is {@code ANNOTATION_MODE}).
     */
    ...
    /**
     * A request to show the {@code InterlinearViewer} and connect it to
     * the multiple tier control panel. Will only have an effect in 
     * {@code #NORMAL_MODE} (is {@code ANNOTATION_MODE}).
     */
    ...
    /**
     * Switches between the modes (perspectives).
     * Initiates unloading of the current mode and loading of the requested mode.
     * 
    ...
    /**
     * Notification that a keyboard shortcut changed.
     */
    ...
    /**
     * Returns an internal id as a string for a mode.
     * The string is in a format like this: "Menu.Options.AnnotationMode".
     *  
     * @param modeId one of the {@code ElanLayoutManager} xxx_MODE constants
     * @return a string id of the mode
     */
     ...
     *
     * @return the (constant for the) current layout mode
     */
    public int getMode() {
        return mode;
    }
     ...
     * Only applicable in {@code #SYNC_MODE}.
     */
    ...
    /**
     * Checks if there is an initialized, active layout manager and 
     * forwards the call to that manager.
     */
    ...
    /**
     * Checks if a Component is added to the content pane of the ELAN frame.
     *
     * @param component the component that is looked for in the content pane
     *
     * @return {@code true} if the component is on the content pane, {@code false}
     * otherwise
     */
	 ...
	 * Forwards to the active manager, clears the container.
	 */
	...
	/**
	 * Called when the file and window is going to be closed.  
	 * Required actions like saving unsaved changes, preferences, etc 
	 * should be done here.
	 *
	 */
    ...
    /**
     * Returns a reference to the frame containing the content pane the layout
     * of which is managed here.
     *
     * @return the frame
     */
    ...
    /**
     * Gives access to the viewer manager.
     * 
    ...
    /**
     * Enables / disables command actions.
     * 
     * @param actionList a list of all actions
     * @param enabled if {@code true}, enables all the actions, 
     * 				if {@code false}, disables all the actions
     */
	...
	/**
	 * Returns whether the layout has been fully initialized.
	 * 
	 * @return {@code true} if initialization is completed
	 */
	 ...
	 * @return {@code true} if attached, {@code false} if detached
	 */
     ...
     * 
     * @return an array of {@code PlayerLayoutModel} objects.
     */
    ...
    /**
     * Returns a list of media players. 
     * 
     * @return a list of {@code PlayerLayoutModel} objects
     */
	...
	/**
	 * Returns a list of viewers implementing the {@code Zoomable} interface.
	 * 
	 * @return a list of {@code Zoomable} viewers, provided by the current mode 
	 * layout manager.  
	 */
     ...
     * (the content pane of the ELAN frame) messed up the layout of some components.
