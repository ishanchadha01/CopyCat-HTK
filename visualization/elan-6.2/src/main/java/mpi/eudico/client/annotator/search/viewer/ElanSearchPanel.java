...
/**
 * The main panel for a search in an ELAN transcription.
 * 
...
public class ElanSearchPanel extends AbstractComplexSearchPanel
     ...
     *
     * @param viewerManager the viewer manager for this document/frame
     */
    ...
    /**
     * Notification that query execution started.
     */
    @Override
    ...
    /**
     * Handles a PatternSyntaxException.
    ...
    /**
     * Disconnect from the viewer manager and dispose the dialog.
     */
    ...
    /**
     * Shows a file browser and reads an ELAN query file.
     */
    @Override
	protected void read() {
...
//        	}
    ...
    /**
     * Shows a file browser and saves an ELAN query file.
     */
    @Override
	protected void save() {
