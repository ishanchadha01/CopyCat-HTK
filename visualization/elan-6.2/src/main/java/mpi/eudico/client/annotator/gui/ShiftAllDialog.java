...
/**
 * A dialog that allows the user to enter a {@code shift} value to be applied
 * to all annotations.
 * This will cause all annotations in the transcription to be moved forward or 
 * backward with the specified amount of time. The implementation operates on
 * the time slots directly (instead of on the annotations themselves).
 *
 * @author Han Sloetjes
...
public class ShiftAllDialog extends ClosableDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancelButton) {
            ...
            c.execute(transcription, new Object[] { Long.valueOf(longValue) });
        }
    }
}
