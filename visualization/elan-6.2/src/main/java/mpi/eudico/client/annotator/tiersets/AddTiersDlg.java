...
/**
 * A dialog for adding tiers to a tier set. 
 */
...
public class AddTiersDlg extends ClosableDialog implements ActionListener {
	 ...
	 * @param manageTierSetDlg the source or parent dialog
	 * @param tierList a list of tier names
	 */
...
//		}
	...
	/**
	 * Initializes the tier table pane.
	 */
    ...
    /**
     * Scans the folders for eaf files and adds them to the files list,
     * recursively.
     *
						...
						public void run() {
							...
							if( allTierNames.isEmpty() ){															
								...
								if(tierTable instanceof TierExportTable) {
									...
									LOG.warning("tierTable is not of class TierExportTable");
								}
