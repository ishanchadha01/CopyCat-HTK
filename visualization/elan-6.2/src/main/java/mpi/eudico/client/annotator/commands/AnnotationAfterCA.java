...
/**
 * A command action for creating a new annotation after a given annotation.
 *
 * @author Han Sloetjes
 */
@SuppressWarnings("serial")
public class AnnotationAfterCA extends CommandAction
    implements ActiveAnnotationListener {
    private Annotation activeAnnotation;

    /**
     * Creates a new AnnotationAfterCA instance
     *
     * @param viewerManager the viewer manager
     */
    public AnnotationAfterCA(ViewerManager2 viewerManager) {
        super(viewerManager, ELANCommandFactory.NEW_ANNOTATION_AFTER);
