...
public abstract class AbstractExtTierExportDialog extends AbstractBasicExportDialog {   
    ...
    /**
     * Creates a new AbstractTierExportDialog instance for export of multiple 
     * files.
     *
     * @param parent the parent frame
     * @param modal whether this dialog should be modal
    ...
    /**
     * Sets the selection mode (tier, type etc) one of the constants of the 
     * AbstractTierSortAndSelectPanel.
     * 
     ...
     * 
     * @param rootsOnly if true only top level tiers are shown, otherwise all tiers 
