...
/**
 * A class to create copies of annotations on copies of tiers. 
 * Two main issues: <ul>
 * <li>the tier names that have been stored in AnnotationDataRecords have to be
 * mapped to the names of the copies of the tiers
 * <li>if the toplevel tier of the copies is not an independent tier, a suitable
...
public class TierCopier {
    ...
    /**
     * Suitable for recreation of annotations on root tiers or time-subdivision
     * tiers.
    ...
    /**
     * Suitable for recreation of annotations on root tiers. 
     * Now calls {@link mpi.eudico.client.annotator.util.AnnotationRecreator#createAnnotationFromTree(Transcription, DefaultMutableTreeNode, boolean)}.
     *
     * @param trans the transcription
     * @param root the root node
     * @param tierMapping mappings of old tier names to new tier names
     *
