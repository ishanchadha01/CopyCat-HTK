...
/**
 * A utility class for exporting to tab delimited text.
 *
 * @author Alexander Klassmann
 * @version Apr 20, 2004
 * @version June 30, 2005 added optional export of time values in milliseconds
 ...
 * @version Aug 2017 changed all static methods to instance methods so that it is easier to configure
...
public class Transcription2TabDelimitedText {
     ...
     * if the EncoderInfo object indicates that the output is a {@code .csv} file.
     * 
     ...
     */
     public void exportTiers(DelimitedTextEncoderInfoTrans encoderInfo) throws IOException {
        ...
        if (encoderInfo.getTierNames() != null) {
        	...
        	LOG.warning("There are no tiers selected for export.");
        }
        try {
        	writer.close();
     ...
     *
     * @param encoderInfo the settings for the encoder, not {@code null}
     *
    ...
    *
    * @param encoderInfo the encoder information object, not {@code null}
    * 
    * @throws IOException any IO exception
    */
     ...
     * Not {@code null}. The embedded list of files is not {@code null} and not empty.
     * 
     * @throws IOException any IO exception
     */
     ...
     * in one row
     * @param includeBeginTime whether or not the begin time is exported
     * @param includeEndTime whether or not the end time is exported
     * @param includeDuration whether or not the duration is exported
     * @param includeHHMM whether the 00:00:00.000 time format is exported
     * @param includeSSMS whether the 00.000 (seconds) time format is exported
     * @param includeMS whether the plain milliseconds format is exported
     * @param includeSMPTE whether the SMPTE format is exported
     * @param actualSMPTEType PAL or NTSC
     * 
    ...
    /**
     * Exports a List of AnnotationCores to Tab delimited text with default settings.
     *
     ...
     *
     * @return the tab separated result string
     */
     public String getTabString(AnnotationCore annotationCore,
