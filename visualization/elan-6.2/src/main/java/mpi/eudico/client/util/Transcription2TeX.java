...
/**
 * A class to export annotation values and their dependencies into a tree, using the
 * LaTeX-pstree format.
 * Not used.
 * 
...
public class Transcription2TeX {
     ...
     * @param beginTime the begin time of the selected interval
     * @param endTime the end time of the selected interval
     * @throws IOException any IO exception
     */
    static public void exportTiers(Transcription transcription, 
     ...
     * 
     * @param rootTiers the selected root tiers
     */
    ...
    /**
     * Checks if each selected tier has maximal one direct child tier.
     * 
     * @param rootTiers the list of root tiers
    ...
    /**
     * Exports a List of AnnotationCores to TeX.
     * 
    ...
    /**
     * Constructs a TeX tree for a single annotation (and its dependent
     * annotations).
     * 
     * @param tierNames
     ...
     *            complete ACM)
     * 
     * @return a string containing a tree in LaTeX-pstree format for the given
     *         annotation
     */
