...
public class MetadataViewer extends JPanel implements PreferencesUser,
    ...
    /**
     * Prepend the given path to the linked files, with the mime-type for CMDI or IMDI files.
     * 
     * @param path the path to the metadata file, insert at index 0
     * @param document the transcription to add the linked file to
     */
    ...
    /**
     * Get the first linked file which has the correct mime-type for a CMDI or IMDI file.
     * 
     * @param document the transcription containing the linked files
     * @return the URL of the first metadata file, or {@code null}
     */
    ...
    /**
     * Remove the first linked file which has the correct mime-type for a CMDI or IMDI file.
     * 
     * @param document the transcription containing the linked files
     */
