...
/**
 * The main panel holding the UI elements of a multiple step process.
...
public class MultiStepPane extends JComponent implements MultiStepControl,
    ...
    /** Constant for the preferred panel dimension */
    ...
    private HashMap<Object, Object> stepProperties;
    ...
    protected void initComponents() {
        ...
        stepProperties = new HashMap<Object, Object>();
     ...
     * to front in the card layout. If the current step specifies a different
     ...
     * @see MultiStepControl#getPropertyKeys()
     */
    @Override
     ...
     * @param forward if true the current step's {@code leaveStepForward()} will be called etc.
     */
    @Override
    ...
    /**
     * Invokes {@code setVisible(visible)} on the button identified by buttonType.
     *
