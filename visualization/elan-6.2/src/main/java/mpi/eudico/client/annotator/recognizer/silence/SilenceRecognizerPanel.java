...
public class SilenceRecognizerPanel extends JPanel implements ChangeListener, ParamPreferences {
	 ...
	 * 
	 * @param selectionPanel the embedded selection panel
	 */
...
//				" " + initialNonSilenceDuration + " " + ElanLocale.getString("PlayAroundSelDialog.Ms"));
	...
	public Map<String, Object> getParamPreferences() {
		...
		sps.put("ManualNoiseThreshold", Double.valueOf(getNoiseThreshold()));
	 ...
	 * 
	 * @return the selections or {@code null}
	 */
	...
	/**
	 * @return {@code true} if the noise threshold is set manually,
	 * or {@code false} if it is set by example (with selections or tier)
	 */
	...
	/**
	 * Updates the panel when switching between manual and example based
	 * threshold specification.
	 *  
	 * @param manual if {@code true} a slider will be shown to set the threshold
	 */
