...
public class TranscriptionTierSortAndSelectPanel extends AbstractTierSortAndSelectPanel 
	...
	/**
	 * Constructor for initializing the panel without a specific tier order 
	 * and/or list of selected tiers.
	 * 
	...
	/**
	 * Constructor for initializing the panel without a specific tier order
	 * and/or list of selected tiers, but with the option to specify the 
	 * tier mode.
	 * 
	 * @param transcription the transcription containing the tiers
	 * @param tierMode the tier mode for the panel one of the 
	 * {@link AbstractTierSortAndSelectPanel.Modes} enumeration
	 */
	...
	/**
	 * Constructor for initializing the panel with a specific tier order
	 * and a list of selected tiers.
	 * 
	 * @param transcription the transcription containing the tiers
	...
	/**
	 * Constructor for initializing the panel with a specific tier order,
	 * a list of selected tiers and the option to reorder the tiers.
	 * 
	 * @param transcription the transcription containing the tiers
	 * @param tierOrder the initial tier order
	 * @param selectedTiers the initial selected tiers
	...
	/**
	 * Constructor for initializing the panel with a specific tier order,
	 * a list of selected tiers and options to reorder and sort the tiers.
	 * 
	 * @param transcription the transcription containing the tiers
	 * @param tierOrder the initial tier order
	 * @param selectedTiers the initial selected tiers
	...
	/**
	 * Constructor for initializing the panel with a specific tier order,
	 * a list of selected tiers, options to reorder and sort the tiers
	 * and with a specific tier mode.
	 * 
	 * @param transcription the transcription containing the tiers
	 * @param tierOrder the initial tier order
	 * @param selectedTiers the initial selected tiers
	...
	/**
	 * Switches dynamically between a view where only root tiers are shown
    ...
    /**
     * Updates the selected and hidden tiers lists based on the selected items
     * in one of the other table models.
     * 
