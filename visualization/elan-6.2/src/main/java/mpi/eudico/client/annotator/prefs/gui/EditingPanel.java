...
/**
 * Panel showing general editing options.
 * Among the options are<ul>
 * <li>flag to set that deselecting the edit box commits changes (default is cancel)
 * <li>flag to set that Enter commits the changes (default is adding a new line
 * char)
 * <li>flag to set that the selection should be cleared after creation of a new annotation,
