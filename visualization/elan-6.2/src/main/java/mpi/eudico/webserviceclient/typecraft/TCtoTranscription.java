...
public class TCtoTranscription {
	...
	/**
	 * 
	 * @param phraseRecords the phrase records
	 * @param textRecord the text record
	 * 
	...
	*/
	...
	/**
	 * Returns the tier with the name and suffix or null if it does not exists.
	 * 
	 ...
	 * @param type the linguistic type for the tier
	 * @param name the base name
	 * @param suffix the speaker suffix
	 * @return the created tier or {@code null}
	 */
	 ...
	 * @return the new annotation or{@code null}
	 */
	...
	/**
	 * Create a depending annotation.
	 * @param wTier the word tier
	 * @param the speaker suffix
	 * @param wRecord the word record
	 * @param parent the parent annotation
	 * @param previous the previous annotation in the chain
