...
public class DemoRecognizerPanel extends JPanel implements ChangeListener, ParamPreferences {
	 ...
	 * @param host the recognizer host environment
	 */
	 ...
	 * 
	 * @return a map containing the current parameter settings
	 */
	@Override
	 ...
	 * 
	 * @param storedPrefs a map containing the last used parameter settings
	 */
	@Override
