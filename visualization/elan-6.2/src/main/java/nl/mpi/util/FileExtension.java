...
public class FileExtension {
	...
	/** The extension for an html file only */
	public static final String[] HTML_ONLY_EXT = new String[] { "html" };
	...
	/** Known extension for JSON files */
	public static final String[] JSON_EXT = new String[] {"json", "jsonld"};
