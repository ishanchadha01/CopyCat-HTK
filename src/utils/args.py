...
def parse_main_args():
    ...
    parser.add_argument('--features_file', type=str, default='configs/features_hands.json')
    ...
    parser.add_argument('--is_single_word', action='store_true', help='Useful for prepare_data usage only.', default=True)
    ...
    parser.add_argument('--train_iters', nargs='*', type=int, default=[5,10,15])
    parser.add_argument('--hmm_insertion_penalty', default=-10)
    parser.add_argument('--n_states', type=int, default=3) # TODO: this is important to change when doing words vs phrases
    ...
    #Arguments for SBHMM
    parser.add_argument('--train_sbhmm', action='store_true', default=False)
