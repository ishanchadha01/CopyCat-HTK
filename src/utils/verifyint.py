...
def verify():
    ...
    parser.add_argument('--macros_filepath', type=str, default='/home/aslr/SBHMM-HTK/SequentialClassification/main/projects/Kinect/testing_verification/newMacros')
    ...
    execute_protocol(args.video_filepath, args.macros_filepath, args.features_config_filepath, args.results_filepath, args.hresults_filepath, args.game_output_filepath)
